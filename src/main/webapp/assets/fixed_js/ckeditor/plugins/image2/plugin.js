...
( function() {
	...
	// 		忙式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖
	// 		弛Align 弛Internal form                  弛Data                         弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛none  弛<wrapper>                      弛<img />                      弛
	// 		弛      弛 <img />                       弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛left  弛<wrapper style=§float:left§>   弛<img style=§float:left§ />   弛
	// 		弛      弛 <img />                       弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛center弛<wrapper>                      弛<p style=§text-align:center§>弛
	// 		弛      弛 <p style=§text-align:center§> 弛  <img />                    弛
	// 		弛      弛   <img />                     弛</p>                         弛
	// 		弛      弛 </p>                          弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛right 弛<wrapper style=§float:right§>  弛<img style=§float:right§ />  弛
	// 		弛      弛 <img />                       弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戌式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
	//
	...
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛left  弛<wrapper class=§left§>         弛<img class=§left§ />         弛
	// 		弛      弛 <img />                       弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛center弛<wrapper>                      弛<p class=§center§>           弛
	// 		弛      弛 <p class=§center§>            弛 <img />                     弛
	// 		弛      弛   <img />                     弛</p>                         弛
	// 		弛      弛 </p>                          弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛right 弛<wrapper class=§right§>        弛<img class=§right§ />        弛
	// 		弛      弛 <img />                       弛                             弛
	// 		弛      弛</wrapper>                     弛                             弛
	// 		戌式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
	//
	// Captioned widget (inline styles)
	// 		忙式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖
	// 		弛Align 弛Internal form                           弛Data                                    弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛none  弛<wrapper>                               弛<figure />                              弛
	// 		弛      弛 <figure />                             弛                                        弛
	// 		弛      弛</wrapper>                              弛                                        弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛left  弛<wrapper style=§float:left§>            弛<figure style=§float:left§ />           弛
	// 		弛      弛 <figure />                             弛                                        弛
	// 		弛      弛</wrapper>                              弛                                        弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛center弛<wrapper style=§text-align:center§>     弛<div style=§text-align:center§>         弛
	// 		弛      弛 <figure style=§display:inline-block§ />弛 <figure style=§display:inline-block§ />弛
	// 		弛      弛</wrapper>                              弛</p>                                    弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛right 弛<wrapper style=§float:right§>           弛<figure style=§float:right§ />          弛
	// 		弛      弛 <figure />                             弛                                        弛
	// 		弛      弛</wrapper>                              弛                                        弛
	// 		戌式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
	//
	...
	// 		弛      弛</wrapper>                              弛                                        弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛left  弛<wrapper class=§left§>                  弛<figure class=§left§ />                 弛
	// 		弛      弛 <figure />                             弛                                        弛
	// 		弛      弛</wrapper>                              弛                                        弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛center弛<wrapper class=§center§>                弛<div class=§center§>                    弛
	// 		弛      弛 <figure />                             弛 <figure />                             弛
	// 		弛      弛</wrapper>                              弛</p>                                    弛
	// 		戍式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
	// 		弛right 弛<wrapper class=§right§>                 弛<figure class=§right§ />                弛
	// 		弛      弛 <figure />                             弛                                        弛
	// 		弛      弛</wrapper>                              弛                                        弛
	// 		戌式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
	//
